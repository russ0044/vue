<template>
  <div class="login-page ios-safe">
    ...
    <div class="card">
      ...
      <div class="scrollbar">
        <div class="menu-box">
          <div class="menu-button" @click="goTo('ai')">🤖 AI 自動訂貨建議</div>
          <div class="menu-button" @click="goTo('manual')">✍️ 手動訂單申請</div>
...
const goTo = (p) => {
  if (p === 'ai') router.push('/orders/manage/ai')
  if (p === 'manual') router.push('/orders/manage/manual')
}
</script>
